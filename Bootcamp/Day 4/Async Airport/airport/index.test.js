...
const {Item, ShopItem} = require('./classes/Item');
const {Person, Passenger, Staff, AirCrew} = require('./classes/Person');
...
var ShopItem1 = new ShopItem('Coffee', 'Shop', 1.5);
var ShopItem2 = new ShopItem('Sandwich', 'Shop', 1.2);
var ShopItem3 = new ShopItem('Tea', 'Shop', 0.99);
var ShopItem4 = new ShopItem('Laptop', 'Shop', 299);
var ShopItem5 = new ShopItem('Headphones', 'Shop', 34.99);
var ShopItem6 = new ShopItem('Chocolate', 'Shop', 2.50);
...
var Person1 = new Passenger('Steve', 'Passenger');
var Person2 = new Passenger('Sam', 'Passenger');
var Person3 = new Passenger('Gemma', 'Passenger');
var Person4 = new Staff('Tom', 'Staff');
var Person5 = new Staff('Lucy', 'Staff');
var Person6 = new Staff('Dave', 'Staff');
var Person7 = new Staff('Anne', 'Staff');
